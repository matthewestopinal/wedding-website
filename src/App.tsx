...
function App() {
  return (
    <div className="App">
      <div>
        Please join us for a reception to celebrate the marriage of Matthew Estopinal and Destiny Carter
      </div>
      <div className='location'>
        <div>February 20 2027</div>
        <div>The Parthenon Nashville </div>
        <div>6 - 10</div>
      </div>
      <div>
        Details: 
        <div>No Gift, No Children :( </div>
      </div>
